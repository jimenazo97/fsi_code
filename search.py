...
def graph_search(problem, fringe):
    ...
    cont=0
    #archivo=open("/Users/andresjimenez/Desktop/IA/PycharmProjects/code/salida.txt","w")
    while fringe:
        node = fringe.pop()
        cont=cont+1
...
def rya_first_graph_search(problem):
    return graph_search(problem,RyA())

def rya_sub_first_graph_search(problem):
    return graph_search(problem,RyA_sub(problem))
